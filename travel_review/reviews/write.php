...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        if ($result) {
            ...
            if (($moderation["status"] ?? "normal") === "flagged") {
                $_SESSION["moderation_message"] = "광고성 게시글로 의심되어 관리자 검토 후 공개됩니다.";
        ...
        <div class="mb-5">
            ...
            <div class="upload-area" id="uploadArea">
                ...
                <div class="upload-placeholder" id="uploadPlaceholder">
                    ...
                    <div class="upload-hint">이미지 최대 20MB · 영상 최대 200MB · 첫 번째 파일이 대표 이미지</div>
                </div>
